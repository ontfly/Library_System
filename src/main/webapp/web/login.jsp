...
<div class="loginmanage">
    <div class="py-container">
        <h4 class="manage-title">书绘人生图书系统</h4>
        <div class="loginform">
            ...
            <div class="tab-content tab-wraped">
                <%--登录提示信息--%>
                <span style="color: #2376ff">${msg}</span>
                <div id="profile" class="tab-pane  active">
                    <form id="loginform" class="sui-form" action="${pageContext.request.contextPath}/login"
                        ...
                        <div class="input-prepend"><span class="add-on loginname">用户名</span>
                            <input type="text" placeholder="用户账户" class="span2 input-xfat" name="email">
                        </div>
...
<script type="text/javascript">
    ...
    if (window != _topWin)
        _topWin.document.location.href = '${pageContext.request.contextPath}/web/login.jsp';
</script>
</html>